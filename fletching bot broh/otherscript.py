...
def main():
    while True:
        click_image("images/bankbooth.png", imagesearch_loop("images/bankbooth.png", .2), "left", random.uniform(.15, .35), offset=random.uniform(10.0, 20.0))
        click_image("images/bankdepositbows.png", imagesearch_loop("images/bankdepositbows.png", .2), "left", random.uniform(.15, .35),
                    offset=10)
        click_image("images/yewlongbank.png", imagesearch_loop("images/yewlongbank.png", .2), "right", random.uniform(.15, .35),
                    offset=7)
        click_image("images/withdrawbows.png", imagesearch_loop("images/withdrawbows.png", .2), "left", random.uniform(.1, .25),
                    offset=4)
        click_image("images/bowstringbank.png", imagesearch_loop("images/bowstringbank.png", .2), "right", random.uniform(.1, .25),
                    offset=7)
        click_image("images/withdrawstring.png", imagesearch_loop("images/withdrawstring.png", .2), "left", random.uniform(.1, .25),
                    offset=4)
        click_image("images/bankclose.png", imagesearch_loop("images/bankclose.png", .2), "left", random.uniform(.15, .35),
                    offset=3)
        click_image("images/bowinv.png", imagesearch_loop("images/bowinv.png", .2), "left", random.uniform(.15, .35),
                    offset=7)
        click_image("images/bowstringinv.png", imagesearch_loop("images/bowstringinv.png", .2), "left", random.uniform(.15, .35),
                    offset=7)
        click_image("images/makebow.png", imagesearch_loop("images/makebow.png", .2), "left", random.uniform(.15, .35),
                    offset=20)
        placeholder = imagesearch("images/lastbow.png", precision=.95)
        placeholder2 = imagesearch("images/newlevel.png", precision=.9)
        counter = 0
        while placeholder[0] == -1 and placeholder2[0] == -1:
            placeholder = imagesearch("images/lastbow.png", precision=.95)
            placeholder2 = imagesearch("images/newlevel.png", precision=.9)
            if placeholder[0] != -1:
                break
            if placeholder2[0] != -1:
                click_image("images/cct.png", imagesearch_loop("images/cct.png", .2), "left",
                            random.uniform(.1, .25),
                            offset=4)
            counter += 1
            print('waiting to finish: ' + str(counter))
